...
class CommunityJoinRequestsScreen extends StatefulWidget {
  ...
  const CommunityJoinRequestsScreen({super.key, required this.community});
...
class _CommunityJoinRequestsScreenState
  ...
  void _reload() {
    _requestsFuture = CommunityService.instance.pendingJoinRequests(
  ...
  Widget build(BuildContext context) {
    return GubScreenBackground(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: false,
          child: FutureBuilder<List<CommunityAccessRequestModel>>(
                            ...
                            Expanded(
                              child: OutlinedButton(
                                onPressed: processing
                                    ? null
                                    : () => _resolve(request, approve: false),
