...
class _CreateProposalScreenState
  ...
  Future<void> _createProposal() async {
    ...
    if (eventDate == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Choose an event date."),
        ),
      );
      return;
    }
    ...
    if (eventTime == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Choose an event time."),
        ),
      );
      return;
    }
                ...
                child: Column(
                  ...
                  children: [
                    _sectionTitle(
                      ...
                      subtitle:
                          "Explain clearly what members will vote on.",
                    ),
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: _inputDecoration(
                          label: "Description",
                          hint:
                              "Add useful details for the group",
                          icon:
                ...
                child: Column(
                  ...
                  children: [
                    _sectionTitle(
                      ...
                      subtitle:
                          "Choose when the approved event will happen.",
                    ),
